            ...
            <Box sx={{
                ...
                <TableContainer sx={{
                    ...
                    <Table>
                        ...
                        <TableBody>
                            <TableRow>
                                <TableCell align='center' sx={{ fontSize: '1.4rem' }}>1</TableCell>
                                <TableCell align='center' sx={{ fontSize: '1.4rem' }}>
                                    <Avatar />
                                </TableCell>
                                <TableCell align='center' sx={{ fontSize: '1.4rem' }}>Nguyễn Văn Đương</TableCell>
                                <TableCell align='center' sx={{ fontSize: '1.4rem' }}>0522081512</TableCell>
                                <TableCell align='center' sx={{ fontSize: '1.4rem' }}>duong.nv194260@sis.hust.edu.vn</TableCell>
                                <TableCell align='center' sx={{ fontSize: '1.4rem' }}>
                                    <Box sx={{
                                        display: 'flex',
                                        alignItems: 'center',
